...
def tracking_objects_in_video(SegTracker, input_video, input_img_seq, fps, frame_num=0, dataset_dir=''):
    ...
    # breakpoint()
    tracking_result_dir = f'{os.path.join(os.path.dirname(os.path.dirname(__file__)), dataset_dir, "video_for_seg")}'
